              ...
              <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium rounded-lg md:flex-row md:space-x-6 md:mt-0 md:border-0 md:mx-auto">
                ...
                <li className="md:hidden">
                  <NavLink to="/cart" className="relative block py-2 text-slate-600">
                    <i className="fa-solid fa-cart-shopping text-2xl"></i>
                    {numberItems > 0 && (
                      <div className="absolute top-[-5px]  bg-emerald-500 text-white w-5 h-5 rounded-full flex items-center justify-center text-xs">
                        {numberItems}
                      </div>
                    )}
                  </NavLink>
                ...
                <li className="md:hidden">
                  <NavLink to="/wishlist" className="relative block py-2 text-slate-600">
                    <i className="fa-solid fa-heart text-2xl"></i>
                    {wishlistCount > 0 && (
                      <div className="absolute top-[-5px]  bg-red-500 text-white w-5 h-5 rounded-full flex items-center justify-center text-xs">
                        {wishlistCount}
                      </div>
                    )}
                  </NavLink>
                ...
                <li className="md:hidden">
                  <button onClick={LogOut} className="block py-2 text-red-600 hover:text-red-700 w-full text-left">
                    Log Out
                  </button>
                </li>
              </ul>
